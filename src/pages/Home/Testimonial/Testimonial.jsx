...
const Testimonial = () => {
    return (
        <section className="w-full flex flex-col justify-center items-center gap-6 mb-[130px]">
            <div className='text-center w-1/2 flex flex-col justify-center items-center'>
                ...
                <h2 className="text-[45px] font-semibold text-darkBlack">What Customer Says</h2>
                <p className="text-gray capitalize">the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. </p>
            </div>
            <section className="flex flex-row gap-8 relative">
                <TestimonialCard />
