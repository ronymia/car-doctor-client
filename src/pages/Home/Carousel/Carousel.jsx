        ...
        {bannerData.map((slide) => (
          <SwiperSlide key={slide.id}>
            <div className="carousel-img md:h-[600px] overflow-hidden">
              <img
                src={slide.image}
                className="bg-center object-fill w-full rounded-xl"
                alt="#"
              />
            </div>
            <div className="w-1/2 absolute md:left-[100px] left-8 md:top-[100px] top-7 flex flex-col md:gap-12 gap-5">
              ...
              <div className="inline-flex gap-4 items-start justify-start">
                <button className="inline-flex justify-center items-center w-[80px] md:w-[170px] h-[28px] md:h-[56px] bg-primary text-white border border-primary md:text-lg text-[10px] font-semibold rounded-[5px]">
                  Discover More
                </button>

                <button className="inline-flex justify-center items-center w-[80px] md:w-[170px] h-[28px] md:h-[56px] text-white bg-transparent  border border-white md:text-lg text-[10px] font-semibold rounded-[5px]">
                  Latest Project
                </button>
              </div>
            </div>
